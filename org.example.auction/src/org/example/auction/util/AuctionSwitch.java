...
public class AuctionSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AuctionPackage.AUCTION_ITEM: {
				AuctionItem auctionItem = (AuctionItem)theEObject;
				T result = caseAuctionItem(auctionItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AuctionPackage.BID: {
	 ...
	 * @generated
	 */
	public T caseAuctionItem(AuctionItem object) {
		return null;
	}
